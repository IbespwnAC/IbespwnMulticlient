namespace ACMulticlient.My
{
    ...
    internal sealed class MyProject
    {
        ...
        {
            public ACMulticlient.dlgIgnoreActivate m_dlgIgnoreActivate;
            [ThreadStatic]
            private static Hashtable m_FormBeingCreated;
            public ACMulticlient.frmMain m_frmMain;
            public ACMulticlient.frmProgress m_frmProgress;
            public ACMulticlient.frmSetup m_frmSetup;
            ...
            public ACMulticlient.dlgIgnoreActivate dlgIgnoreActivate
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_dlgIgnoreActivate = Create__Instance__<ACMulticlient.dlgIgnoreActivate>(this.m_dlgIgnoreActivate);
                ...
                set
                {
                    if (value != this.m_dlgIgnoreActivate)
                    {
                        ...
                        this.Dispose__Instance__<ACMulticlient.dlgIgnoreActivate>(ref this.m_dlgIgnoreActivate);
                    }
                }
            }

            public ACMulticlient.frmMain frmMain
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_frmMain = Create__Instance__<ACMulticlient.frmMain>(this.m_frmMain);
                ...
                set
                {
                    if (value != this.m_frmMain)
                    {
                        ...
                        this.Dispose__Instance__<ACMulticlient.frmMain>(ref this.m_frmMain);
                    }
                }
            }

            public ACMulticlient.frmProgress frmProgress
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_frmProgress = Create__Instance__<ACMulticlient.frmProgress>(this.m_frmProgress);
                ...
                set
                {
                    if (value != this.m_frmProgress)
                    {
                        ...
                        this.Dispose__Instance__<ACMulticlient.frmProgress>(ref this.m_frmProgress);
                    }
                }
            }

            public ACMulticlient.frmSetup frmSetup
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_frmSetup = Create__Instance__<ACMulticlient.frmSetup>(this.m_frmSetup);
                ...
                set
                {
                    if (value != this.m_frmSetup)
                    {
                        ...
                        this.Dispose__Instance__<ACMulticlient.frmSetup>(ref this.m_frmSetup);
                    }
                }
            }
        }
